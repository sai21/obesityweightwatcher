...
public class AppProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case APPS:
                ...
                cursor = database.query(AppEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case APP_ID:
    ...
    private Uri insertApp(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(AppEntry.COLUMN_USER_NAME);
        if (name == null) {
            throw new IllegalArgumentException("App requires a name");
        }

        // Check that the gender is valid
        Integer password = values.getAsInteger(AppEntry.COLUMN_USER_PASSWORD);
        if (password == null) {
            throw new IllegalArgumentException("Apps requires password");
        }
        ...
        long id = database.insert(AppEntry.TABLE_NAME, null, values);
    ...
    private int updateApp(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(AppEntry.COLUMN_USER_NAME)) {
            String name = values.getAsString(AppEntry.COLUMN_USER_NAME);
            if (name == null) {
                throw new IllegalArgumentException("App requires a name");
            }
        ...
        if (values.containsKey(AppEntry.COLUMN_USER_PASSWORD)) {
            String name = values.getAsString(AppEntry.COLUMN_USER_PASSWORD);
            if (name == null) {
                throw new IllegalArgumentException("App requires a password");
            }
        }
        ...
        int rowsUpdated = database.update(AppEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case APPS:
                ...
                rowsDeleted = database.delete(AppEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case APP_ID:
